...
export const updateBrandBasicByAdminValidator = z.object({
    ...
    body: z.object({
        ...
        taxCode: z.preprocess((val) => val === "" ? undefined : val, demoValidator.chuoi("Mã số thuế").max(100, "Mã số thuế không được vượt quá 100 ký tự").optional().nullable()),
        emailContact: z.preprocess((val) => val === "" ? undefined : val, demoValidator.email().optional().nullable()),
        phoneContact: z.preprocess((val) => val === "" ? undefined : val, demoValidator.chuoi("Số điện thoại liên hệ").max(20, "Số điện thoại không được vượt quá 20 ký tự").optional().nullable()),
        link: z.preprocess(
            (value) => {
