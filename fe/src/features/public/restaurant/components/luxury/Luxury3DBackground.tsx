...
export default function Restaurant3DBackground({ children }: Props) {
    ...
    // Hiá»‡u á»©ng Parallax khi rÆ¡ chuá»™t (chá»‰ kÃ­ch hoáº¡t á»Ÿ cháº¿ Ä‘á»™ 3D)
    useEffect(() => {
        if (!is3D) return;

        const handleMouseMove = (e: MouseEvent) => {
            const { clientX, clientY } = e;
            const x = (clientX / window.innerWidth - 0.5) * 35; // Pháº¡m vi dá»‹ch chuyá»ƒn X
            const y = (clientY / window.innerHeight - 0.5) * 35; // Pháº¡m vi dá»‹ch chuyá»ƒn Y
            setMousePos({ x, y });
        };
    ...
    return (
        <div className={`w-full min-h-screen relative overflow-hidden transition-colors duration-700 ${
            ...
            {/* ==================== Lá»šP Há»ŒA TIáº¾T Ná»€N CHÃŒM CULINARY MESH ==================== */}
            <div 
            ...
            {/* ==================== KHÃ”NG GIAN Ná»€N 3D CULINARY AURA (CHá»ˆ Báº¬T KHI is3D === TRUE) ==================== */}
            {is3D && (
                <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
                    {/* --- Táº¦NG 1: CÃC KHá»I Cáº¦U HÃ€O QUANG 3D NGá»ŒC BÃCH & Há»” PHÃCH Vá»šI PARALLAX NHáº¸ --- */}
                    <div 
                    ...
                    {/* --- Táº¦NG 2: LÆ¯á»šI KHÃ”NG GIAN ISOMETRIC CHIá»€U SÃ‚U --- */}
                    ...
                    {/* --- Táº¦NG 3: CÃC LUá»’NG ÃNH SÃNG Dá»ŒC CULINARY BEAMS --- */}
                    ...
                    {/* --- Táº¦NG 4: Háº T Bá»¤I BIá»‚U TÆ¯á»¢NG áº¨M THá»°C 3D LÆ  Lá»¬NG (PARALLAX JEWELS) --- */}
                    <div 
            ...
            {/* ==================== KHÃ”NG GIAN Ná»˜I DUNG CHÃNH (RELATIVE Z-10) ==================== */}
